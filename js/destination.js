...
window.addEventListener('DOMContentLoaded',()=>{
    if(innerWidth>=1200){
        document.body.style.background = "url('./assets/destination/background-destination-desktop.jpg') no-repeat";
        document.body.style.backgroundPosition = "center";
        document.body.style.backgroundSize = "cover";
    }
    else if(innerWidth>=800){
        document.body.style.background = "url('./assets/destination/background-destination-tablet.jpg') no-repeat";
        document.body.style.backgroundPosition = "center";
        document.body.style.backgroundSize = "cover";
    }
    else{
